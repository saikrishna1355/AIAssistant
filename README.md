...
The overlay is a standard visible desktop window. It does not use content protection, screen-capture blocking, meeting-app bypasses, or proctoring/monitoring evasion.
